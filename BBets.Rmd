...
print(uci)
```
The graph shoes the about 4.4 will be the amount pay off.  
...
print(uci)
```
28 people in class then 2:1 bet is about fair.
<!--Explain and display the results of your method of coming up with the estimate of professor Brownlows betting profits!-->


# Discussion and Conclusion
28 people in class then 2:1 bet is about fair. The graph shoes the about 4.4 will be the amount pay off.  
